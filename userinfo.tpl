<div class="form"><div class="form__header"><h1 class="form__title">Просмотр профиля </h1>
<a href="/" class="form__btn icon-at-left"><span class="far fa-home"></span>На главную</a></div><div class="usp">
<div class="usp__columns d-flex jc-flex-start ai-center"><div class="usp__left">
