<div class="item item--announce"><div class="item__header"><h3 class="item__title"><a href="{full-link}">{title}</a></h3>
...
<div class="item__meta-item">{date}</div><div class="item__meta-item">Просмотров: {views}</div>
...
<div class="item__desc flex-grow-1 d-flex fd-column"><p class="item__text line-clamp">{short-story limit="500"}</p>
...
[xfgiven_time]<div class="item__size"><span class="fal fa-download"></span>[xfvalue_time]</div>[/xfgiven_time]
