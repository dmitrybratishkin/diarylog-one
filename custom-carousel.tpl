<a class="carousel-item" href="{full-link}"><div class="carousel-item__title">{title}</div>
...
[/xfnotgiven_poster_url][xfgiven_quality]<div class="carousel-item__label">[xfvalue_quality]</div>[/xfgiven_quality]</div></a>